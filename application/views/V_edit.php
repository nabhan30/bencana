                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php foreach($data as $v): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $v["tanggal_masuk"]; ?></td>
                                                <td><?php echo $v["tanggal_kadaluarsa"]; ?></td>
                                                <td><?php echo $v["harga_beli"]; ?></td>
                                                <td><?php echo $v["harga_jual"]; ?></td>
                                                <td>
                                                <a href="<?php echo base_url() ?>C_superadmin/edit/<?php echo $v['kode_barang'] ?>">Edit </a><br>
                                                <a href="<?php echo base_url() ?>C_superadmin/delete/<?php echo $v['kode_barang'] ?>" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
                                                </td>
