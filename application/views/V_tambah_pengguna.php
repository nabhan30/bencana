...
<body>
    <div class="wrapper">
        <form role="form" method="post" action="<?= base_url('C_user/tambah_pengguna');?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" placeholder="Masukan Nama Lengkap" required oninvalid="this.setCustomValidity('Masukan nama lengkap')" oninput="setCustomValidity('')">
                                        </div>
                                        <div class="form-group">
                                            <label>User Name</label>
                                            <input class="form-control" name="username" placeholder="Masukan Username" required oninvalid="this.setCustomValidity('Masukan username')" oninput="setCustomValidity('')">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                        ...
                                        <div class="form-group">
                                            <label>Jabatan</label>
                                            <select class="form-control" name="jabatan" required oninvalid="this.setCustomValidity('Pilih jabatan')" oninput="setCustomValidity('')">
